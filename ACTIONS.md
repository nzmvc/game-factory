...
| F-006 | Gameplay kaydı → 3–5 reklam kreatifi (3 sn kuralı) | M6 | Nazım (+A6) | ⬜ | 21 Tem |
| F-007 | İmza mutabakatı (kim ödüyor + gelir modeli taahhüdü) — yazılı | Kapı | Nazım + Analist | ⬜ | 21 Tem |
| F-008 | Pazarlanabilirlik testi canlıya alma ($100–200) | M6 | Analist | ⛔ Bütçe onayı (F-007 ön koşul) | 22 Tem |
